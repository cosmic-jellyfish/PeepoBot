...
| `IP`  | 	Shows the members information regarding IP address (Not really useful tbh). | ✅ | 
...
| Command  | Description | Status | 
| ------------- | ------------- | -------------: |
| `ApexLegendsDrop` | Woohoo. I pick for you where you should die(drop). | ✅ |
...
| Command  | Description | Status | 
| ------------- | ------------- | -------------: |
| `4chan` | Fetch image + text of specified board. | ✅ |
| `Bunny` | Fetch a bunny. | ✅ | 
| `Cat`   | Fetch a kitty. | ✅ | 
...
| Command  | Description | Status | 
| ------------- | ------------- | -------------: |
| `Csgo`     |   Get stats of any CSGO player. | ✅ | 
| `Destiny2`     |  Get stats of any Destiny2 player. | ✅ | 
| `Fortnite`    |   Get stats of any Fortnite player. | ✅ | 
| `Rainbow Six Seige`     |   Get stats of any Rainbow Six player. | ✅ | 
...
| Command  | Description | Status | 
| ------------- | ------------- | -------------: |
| `Astronauts`  | Hey Houston, how many astronauts are up there? | ✅ | 
| `Earth`  | Excuse me ISS, could you send me an Earth Picture? | ✅ | 
